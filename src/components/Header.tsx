  ...
  { tint: "bg-[#14317A]", angle: "3.2deg", string: 15 },
        ...
        <div className="hidden md:block">
          <a
            href="#book"
            data-cursor="book"
            className="btn-ink btn-press inline-flex items-center gap-2 border border-[#78EFEB] bg-[#78EFEB] px-5 py-2.5 text-sm font-semibold text-[#14317A] hover:bg-[#14317A] hover:text-white hover:border-[#78EFEB] transition-all duration-300shadow-[0_10px_20px_-8px_rgba(14,26,58,0.85)] [--ink-fill:var(--color-navy-2)]"
          >
            Book a call
          </a>
        </div>
      ...
      <div
        ...
        inert={!open}
        aria-hidden={!open}
        className={`overflow-hidden bg-paper text-white md:hidden ${
