        ...
        >
          <div className="container-x flex flex-1 items-center py-10">
            <div className="max-w-2xl">
              <span data-h="kicker" className="kicker text-[#78efeb]">
              ...
              <p
                data-h="sub"
                className="mt-7 max-w-lg text-lg leading-relaxed text-white/80 text-pretty"
              >
              ...
              >
                <Magnetic>
                  <a
                    ...
                    data-cursor="book"
                    className="btn-ink btn-press inline-flex items-center justify-center gap-2 bg-[#78efeb] px-8 py-4 text-sm font-semibold text-navy shadow-[0_14px_28px_-12px_rgba(120,239,235,0.4)] [--ink-fill:var(--color-navy)] hover:text-white"
                  >
                ...
                <Magnetic strength={0.25}>
                  <a
                    href="#work"
                    data-cursor="view"
                    className="btn-ink btn-press inline-flex items-center justify-center gap-2 border border-white/30 bg-white/5 px-8 py-4 text-sm font-semibold text-white [--ink-fill:#ffffff] hover:text-navy"
                  >
              ...
              <p
                data-h="cta-note"
                className="mt-4 font-mono text-[0.62rem] uppercase tracking-[0.16em] text-[#78efeb]"
              >
          ...
          <div data-h="meta" className="container-x">
            <div className="grid grid-cols-1 items-center gap-4 border-t border-white/12 py-4 sm:grid-cols-[auto_1fr_auto]">
              <div className="flex items-baseline gap-3">
                <span aria-hidden="true" className="text-sm text-[#78efeb]">
                  ★★★★★
                </span>
                <span className="font-mono text-[0.62rem] uppercase tracking-[0.16em] text-[#B9CBE4]">
                  4.9/5 · 120+ founders
                </span>
              </div>
              ...
              <div className="hidden items-center justify-center gap-3 md:flex">
                ...
                >
                  <span className="font-mono text-[0.6rem] uppercase tracking-[0.14em] text-[#B9CBE4]">
              ...
              >
                ...
                <span className="font-mono text-[0.6rem] uppercase tracking-[0.14em] leading-relaxed text-[#B9CBE4]">
                  {FOUNDER.kicker}
                  <br />
                  <span className="text-white">{FOUNDER.duration}</span>
                </span>
              </a>
            </div>
          </div>
          ...
          <div data-h="wordmark" className="relative mt-2 pb-4 sm:pb-6">
            <span
              aria-hidden="true"
              className="kicker absolute -top-3 left-5 hidden items-center gap-3 text-[#B9CBE4] lg:flex"
            >
              Scroll
