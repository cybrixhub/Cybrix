    ...
    items: [
      {
        ...
        tagline:
          "Generate qualified student leads for your study abroad consultancy — not random enquiries.",
        bullets: [
          "Paid social advertising",
          "Student qualification funnels",
          "Destination-specific creative",
          "Retargeting campaigns",
        ],
        problem:
          "Study abroad consultancies spend heavily on digital advertising but still struggle to generate students who are genuinely ready to proceed. Counsellors waste time filtering unqualified enquiries — students who don't meet requirements, lack financial readiness, or have no realistic application timeline.",
        solution:
          "A complete student acquisition system combining precision targeting, conversion-focused ad creative and intelligent qualification funnels — designed to attract students with genuine study abroad intent and deliver them ready for your counselling team.",
        deliverables: [
          "Student acquisition strategy",
          "Study abroad lead generation campaigns",
          "Audience research & targeting",
          "Paid social advertising",
          "Professional campaign creatives",
          "Lead qualification funnels",
          "Conversion tracking",
          "Student retargeting campaigns",
          "Campaign optimisation",
          "Monthly performance reporting",
        ],
        process: [
          { step: "01", title: "Discovery", description: "Define the consultancy's destination portfolio, student profile, intake timeline and qualification criteria." },
          { step: "02", title: "Audience Research", description: "Research prospective students by location, educational background, destination interest and intent signals." },
          { step: "03", title: "Campaign Launch", description: "Paid social campaigns live within two weeks — creative built around destinations, universities, scholarships and upcoming intakes." },
          { step: "04", title: "Qualification", description: "Lead forms capture academic profile, preferred country, intended programme, budget and application timeline before prospects reach your counsellors." },
          { step: "05", title: "Optimise", description: "Campaign data reviewed to improve targeting, creative and lead quality. Retargeting reconnects warm audiences. Monthly reporting." },
        ],
        fitFor: [
          "Study abroad consultancies",
          "Education consultant agencies",
          "International student recruitment firms",
          "Consultancies representing multiple universities",
        ],
        faqs: [
          {
            question: "What counts as a qualified student lead?",
            answer: "Academic profile aligned with available opportunities, demonstrated financial capacity, genuine study abroad intent, destination preferences matching your portfolio, a realistic upcoming application timeline, and usable contact details.",
          },
          {
            question: "How do you stop unqualified enquiries reaching counsellors?",
      ...
      },
      {
        ...
        name: "Deal Drive",
        tagline:
          "Build a stronger property pipeline — qualified buyer and investor leads for developers, agencies and consultants.",
        bullets: [
          "Buyer & investor targeting",
          "Budget qualification",
          "Property-specific creatives",
          "Retargeting campaigns",
        ],
        problem:
          "Real estate businesses generate hundreds of leads through digital advertising but struggle to convert those enquiries into meaningful sales conversations. Most prospects are checking prices, have insufficient budgets, or have no immediate purchase intention — your CRM fills up while your pipeline stays thin.",
        solution:
          "A performance-driven property lead generation system that reaches relevant buyers and investors, qualifies for budget and buying intent before leads reach your sales team, and retargets warm property audiences with deal-specific creative.",
        deliverables: [
          "Real estate marketing strategy",
          "Buyer & investor audience research",
        ...
        process: [
          { step: "01", title: "Market Analysis", description: "Territory, buyer personas, property types, investment profile and competitor spend reviewed before strategy is finalised." },
          { step: "02", title: "Audience Build", description: "Audiences built on demographics, locations, property interests, investment behaviour and digital intent signals." },
          { step: "03", title: "Campaign Launch", description: "Geo-targeted campaigns live within two weeks — creative built around specific projects, property categories and investment opportunities." },
          { step: "04", title: "Qualification", description: "Lead forms capture approximate investment budget, property preference, buying timeline and contact details — before prospects reach your sales team." },
          { step: "05", title: "Optimise", description: "Targeting, creatives and qualification criteria refined continuously. Weak audiences killed, strong ones scaled. Performance reported monthly." },
        ],
        fitFor: [
          "Property developers",
          "Real estate agencies",
          "Property consultants",
          "Investment project sales teams",
        ],
        faqs: [
          {
            question: "What makes a property lead 'qualified'?",
            answer: "Budget relevant to the promoted property, expressed interest in a specific project or category, buying or investment intent, an identified decision timeline, location preference matching your inventory, and valid contact information.",
          },
          {
            question: "What property types does this work for?",
            answer: "Residential, commercial and investment properties — apartments, plots, villas, commercial units, and specific developments. Campaigns are structured around your current inventory and project pipeline.",
          },
        ],
      ...
      },
      {
        ...
        tagline:
          "Attract more patients and grow your practice — with treatment-specific digital marketing and local targeting.",
        bullets: [
        ...
        problem:
          "Today's patients research healthcare providers online before making contact. Low online visibility, generic clinic promotion, and unclear digital patient journeys mean they choose a provider who appeared first and communicated more clearly.",
        solution:
          "A patient acquisition system built around how people discover, evaluate and select healthcare providers — treatment-specific campaigns, local targeting, trust-focused creative and clear patient enquiry funnels that convert interest into booked consultations.",
        deliverables: [
          "Healthcare digital marketing strategy",
          "Local patient audience research",
          "Treatment-specific campaigns",
          "Paid social advertising",
          "Professional healthcare creatives",
          "Patient enquiry funnels",
          "Conversion tracking",
          "Retargeting campaigns",
          "Campaign optimisation",
        ...
        process: [
          { step: "01", title: "Audit", description: "Current patient acquisition, online visibility, competitor presence and priority treatment lines reviewed before strategy is built." },
          { step: "02", title: "Local Targeting", description: "Patient audiences built within your geographic service area, layered with treatment-specific interest and intent signals." },
          { step: "03", title: "Treatment Campaigns", description: "Individual campaigns per treatment or service — not generic clinic promotion. Each has dedicated creative and a focused patient landing page." },
          { step: "04", title: "Patient Funnels", description: "Clear digital journeys from treatment awareness to practice enquiry, with no unnecessary friction in the path to contact." },
          { step: "05", title: "Optimise", description: "Campaign data reviewed continuously to identify stronger treatments, audiences and creatives. Retargeting reconnects interested patients. Monthly reporting." },
        ],
        fitFor: [
          "Hospitals & multi-location clinics",
          "Dental practices",
          "Aesthetic & med spa clinics",
          "Chiropractic & specialist practices",
          "Private healthcare providers",
        ],
        faqs: [
          {
            question: "Why run campaigns by treatment rather than by clinic?",
            answer: "Treatment-specific campaigns produce stronger patient intent. A person looking for 'hair loss treatment' responds to a campaign about that service, not a general clinic ad. Each treatment gets its own audience, creative and enquiry funnel.",
          },
          {
            question: "What counts as a qualified patient enquiry?",
            answer: "Interest in a treatment your practice provides, location within your service area, intent to seek information or arrange a consultation, and valid contact details for your team to follow up.",
          },
        ],
        relatedCase: "meridian-podiatry",
      },
